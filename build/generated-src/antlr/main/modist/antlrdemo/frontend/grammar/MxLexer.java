...
public class MxLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"ELSE", "FOR", "WHILE", "BREAK", "CONTINUE", "RETURN", "IntegerLiteral", 
			"BooleanLiteral", "StringLiteral", "FormatStringBegin", "FormatStringEnd", 
			"FormatStringMiddle", "FormatStringAtom", "StringCharacter", "FormatStringCharacter", 
			"PrintableCharacter", "FormatPrintableCharacter", "EscapeCharacter", 
			"FormatEscapeCharacter", "Identifier", "ADD", "SUB", "MUL", "DIV", "MOD", 
			"GT", "LT", "GE", "LE", "NE", "EQ", "LOGICAL_AND", "LOGICAL_OR", "LOGICAL_NOT", 
			"SHL", "SHR", "AND", "OR", "XOR", "NOT", "ASSIGN", "INC", "DEC", "DOT", 
			"LBRACK", "RBRACK", "LPAREN", "RPAREN", "QUESTION", "COLON", "SEMI", 
			"COMMA", "LBRACE", "RBRACE", "WhiteSpace", "LineComment", "BlockComment"
		};
	}
