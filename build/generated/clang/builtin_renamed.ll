...
define dso_local i32 @_array.size(ptr nocapture noundef readonly %0) local_unnamed_addr #0 {
...
define dso_local i32 @string.length(ptr nocapture noundef readonly %0) local_unnamed_addr #1 {
...
define dso_local i32 @string.parseInt(ptr nocapture noundef readonly %0) local_unnamed_addr #6 {
...
; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(argmem: read)
define dso_local i32 @string.ord(ptr nocapture noundef readonly %0, i32 noundef %1) local_unnamed_addr #0 {
