...
public class BuiltinFeatures {
    public static final Symbol.TypeName INT_TYPE_NAME = new Symbol.TypeName(MxLexer.VOCABULARY.getSymbolicName(MxLexer.INT));
    public static final Symbol.TypeName BOOL_TYPE_NAME = new Symbol.TypeName(MxLexer.VOCABULARY.getSymbolicName(MxLexer.BOOL));
    public static final Symbol.TypeName STRING_TYPE_NAME = new Symbol.TypeName(MxLexer.VOCABULARY.getSymbolicName(MxLexer.STRING));
